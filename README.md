...
6. [Corresponder a caracteres que ocorrem uma ou mais vezes](#regex)
7. [Corresponder a caracteres que ocorram zero ou mais vezes](#regex)
8. [Correspondência de padrões iniciais de string](#regex)
9. [Correspondência de padrões de string de finalização](#regex)
10. [Combine todas as letras e números](#regex)
11. [Combine tudo menos letras e números](#regex)
12. [Corresponder a todos os números](#regex)
13. [Corresponder a todos os não-números](#regex)
14. [Corresponder ao espaço em branco](#regex)
15. [Corresponder caracteres sem espaço em branco](#regex)
16. [Especifique o número superior e inferior de correspondências](#regex)
17. [Especifique apenas o menor número de correspondências](#regex)
18. [Especifique o número exato de correspondências](#regex)
19. [Verificar se há todos ou nenhum](#regex)
20. [Antecipação Positiva e Negativa](#regex)
21. [Verifique se há agrupamento misto de caracteres](#regex)
22. [Reutilizar padrões usando grupos de captura](#regex)
23. [Use grupos de captura para pesquisar e substituir](#regex)
24. [Remova o espaço em branco do início e do fim](#regex)
